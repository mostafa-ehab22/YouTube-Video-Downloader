...
A lightweight YouTube video downloader designed for reliability and ease of use. Supports multiple resolutions (360p to 1080p), automatic format detection with size previews, and organized local output, all through a clean command-line interface.
